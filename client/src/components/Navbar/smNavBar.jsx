        ...
        </div>
        {
          isDropDownOpen && (            
            <div className="bg-gray-50 absolute right-0 top-14 w-full">
              <ul className="flex flex-col items-center justify-center gap-4 block px-4 py-2 hover:bg-gray-100 font-bold">
                ...
                <li className={ type==="faculty" && 'bg-gray-600 text-center w-full border border-grey-50 shadow-xl py-1 px-2 rounded-sm text-blue-50 transition duration-700 ease-in-out delay-150'}>
                  <Link to={"/faculty"}>Faculty</Link>
                </li>
                <li className={ type==="visitingfaculty" && 'bg-gray-600 text-center w-full border border-grey-50 shadow-xl py-1 px-2 rounded-sm text-blue-50 transition duration-700 ease-in-out delay-150'}>
                  <Link to={"/visitingfaculty"}>Visiting Faculty</Link>
                </li>
                <li className={ type==="pg" && 'bg-gray-600 text-center w-full border border-grey-50 shadow-xl py-1 px-2 rounded-sm text-blue-50 transition duration-700 ease-in-out delay-150'}>
                  <Link to={"/pg"}>PG</Link>
                </li>
                ...
                {reduxState?.user ? (
                  <div>
                     <li className={ type==="conference" && 'bg-gray-600 text-center w-full border border-grey-50 shadow-xl py-1 px-2 rounded-sm text-blue-50 transition duration-700 ease-in-out delay-150'}>
                      <Link to={"/conference"}>Conference</Link>
                    </li> 
                    <li className={ type==="feedback" && 'bg-gray-600 text-center w-full border border-grey-50 shadow-xl py-1 px-2 rounded-sm text-blue-50 transition duration-700 ease-in-out delay-150'}>
