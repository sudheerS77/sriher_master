                    ...
                    <TableBody>
                        ...
                        feedbackData?.map((row) => (            
                            <TableRow key={row.id}  className="hover:bg-gray-100">
                                ...
                                <TableCell className="tableCell">
                                    <span className={row.feedback_status === "Active" ? "p-2 rounded-sm text-white bg-green-900" : "p-2 rounded-sm text-yellow-100 bg-yellow-500"}>{row.feedback_status}</span>
                                </TableCell>
                                <TableCell className="tableCell">
                                    <div className="flex items-center justify-around">
                                        <Link to={`/admin/feedback/${row._id}`}>
                                            <BiEdit className="w-6 h-6 text-blue-600"/>
                                        </Link>
                                        <Link to={`/admin/faculty-feedback/${row._id}`}>
                                            <IoOpen className="w-6 h-6 text-blue-600"/>
                                        </Link>
