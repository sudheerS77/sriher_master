      ...
      <div className="flex flex-col items-end gap-10 bg-white px-4 py-5 border shadow-xl rounded-md">
        <div className="w-full flex flex-wrap gap-5">
          <TextField
            ...
            onChange={(e) =>
              setAchievements((prev) => ({ ...prev, name: e.target.value }))
            }
          />
          <TextField
            required
            ...
            onChange={(e) =>
              setAchievements((prev) => ({ ...prev, image: e.target.value }))
            }
          />
          <TextField
            required
          ...
          <TextField
            ...
            onChange={(e) =>
              setAchievements((prev) => ({ ...prev, degree: e.target.value }))
            }
          />
          <TextField
            required
            ...
            onChange={(e) =>
              setAchievements((prev) => ({ ...prev, position: e.target.value }))
            }
          />
          <TextField
            id="status"
            ...
            onChange={(e) =>
              setAchievements((prev) => ({ ...prev, userType: e.target.value }))
            }
          >
            <MenuItem value={"UGStudent"} key="UGStudent">
              UG Student
            </MenuItem>
            <MenuItem value={"PGStudent"} key="PGStudent">
              PG Student
            </MenuItem>
          ...
          <TextField
            ...
            onChange={(e) =>
              setAchievements((prev) => ({ ...prev, status: e.target.value }))
            }
          >
